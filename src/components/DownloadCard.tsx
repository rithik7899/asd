    ...
    <Card className="w-[600px] p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          ...
          { label: "Normalised Marks", value: normalizedMarks },
          { label: "Raw Rank", value: rawRank },
          { label: "Normalised Rank", value: normalizedRank },
        ].map((item, index) => (
          <div key={index}>
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell className="text-center">{subjectData.right}</TableCell>
            <TableCell className="text-center">{subjectData.wrong}</TableCell>
            <TableCell className="text-center">{subjectData.marks}</TableCell>
          </TableRow>
